/**
 * Sistema de logging estructurado para el servicio de usuarios
 */
...
/**
 * Instancia del logger para el servicio de usuarios
 */
export const logger = new ServiceLogger('svc-users');
