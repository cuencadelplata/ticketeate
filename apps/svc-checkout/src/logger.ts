/**
 * Sistema de logging estructurado para el servicio de checkout
 */
...
/**
 * Instancia del logger para el servicio de checkout
 */
export const logger = new ServiceLogger('svc-checkout');
