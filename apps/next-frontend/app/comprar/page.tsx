...
export default function ComprarPage() {
  ...
  return (
    <div className="flex min-h-screen justify-center bg-[#f5f7fb] p-6 text-black">
      <aside className="flex h-[88vh] max-h-[88vh] w-[600px] flex-col overflow-hidden rounded-2xl bg-white shadow-md">
        {/* Header */}
        ...
        <div className="flex-1 overflow-y-auto p-2">
          {(Object.keys(SECTORES) as SectorKey[]).map(key => {
            ...
            return (
              <label
                key={key}
                className={`m-1 grid cursor-pointer items-center gap-3 rounded-xl border p-3 [grid-template-columns:24px_1fr_auto] ${activo ? 'border-transparent bg-blue-50 ring-2 ring-blue-500' : 'border-gray-200 bg-white'}`}
              >
        ...
        <div className="mt-auto flex flex-col gap-3 border-t border-gray-200 bg-white p-4">
          ...
          <div className="flex flex-col">
            ...
            <select
              ...
              className="rounded-lg border border-gray-300 bg-gray-50 px-3 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
              {[1, 2, 3, 4, 5].map(n => (
