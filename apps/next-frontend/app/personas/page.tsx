    ...
    <div className="min-h-screen bg-black py-16 px-4">
      <div className="max-w-7xl mx-auto pt-16">
        ...
        <div className="text-center mb-24">
          <h1 className="text-5xl md:text-7xl bg-gradient-to-b from-white to-gray-300 bg-clip-text text-transparent mb-6 pb-2 font-instrument-serif">
            Personas
            <br />
        ...
        {/* Students Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-24 px-48">
          {students.map((student, index) => (
            ...
            >
              {/* Profile Picture */}
              <div className="w-36 h-36 mx-auto mb-2 relative overflow-hidden rounded-full">
                <Image
                  src={student.avatar}
                  alt={student.name}
                  fill
              ...
              {/* Name */}
              <h3 className="text-sm font-medium text-gray-400 group-hover:text-primary transition-colors duration-300">
                {student.name}
              </h3>
            </a>
          ))}
        ...
        <div className="mt-32 text-center">
          <div className="flex items-center justify-center mb-6 px-12">
            ...
            <h2
              className="text-4xl md:text-5xl bg-gradient-to-b from-white to-gray-300 bg-clip-text text-transparent px-8 pb-2"
          ...
          <p className="text-base md:text-lg text-gray-400 max-w-3xl mx-auto mb-16">
            ...
            {professors.map((professor, index) => {
              const ProfessorContent = () => (
                <>
                  ...
                  {/* Name */}
                  <h3 className="text-lg font-bold text-white mb-1">{professor.name}</h3>

                  {/* Location */}
                  <p className="text-sm text-gray-400">{professor.location}</p>
                </>
              );
