  ...
  return (
    <section id="brand-assets" className="bg-stone-900 rounded-xl p-6 border border-stone-800">
      ...
      <p className="text-stone-400 mb-6">
        Wordmark y recursos de marca de Ticketeate en sus diferentes versiones.
      </p>
          ...
          <div className="grid gap-6">
            ...
            <div className="space-y-3">
              ...
              <div className="bg-stone-950 rounded-lg p-8 flex items-center justify-center border border-stone-700">
                <Image
                  src="/wordmark-light.png"
                  alt="Ticketeate wordmark en oscuro"
                  width={320}
                  height={72}
                />
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="space-y-3">
                ...
                <div className="bg-white rounded-lg p-6 flex items-center justify-center">
                  <Image
                    src="/icon-ticketeate.png"
                    alt="Icono Ticketeate claro"
                    width={64}
                    height={64}
                  />
                </div>
          ...
          <div className="space-y-4 text-sm text-stone-300">
            <div>
              ...
              <p className="text-stone-400">
                Mantener un espacio mínimo equivalente a la altura de la letra "T" alrededor del
                wordmark.
              </p>
            </div>
            <div>
              ...
              <p className="text-stone-400">
                El wordmark no debe ser menor a 120px de ancho en medios digitales o 20mm en medios
                impresos.
              </p>
            </div>
            <div>
              ...
              <p className="text-stone-400">
                Usar únicamente los colores especificados: naranja principal, blanco, negro o
                monocromático.
              </p>
            </div>
          </div>
