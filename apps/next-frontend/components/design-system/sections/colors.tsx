...
export function ColorsSection() {
  ...
  return (
    <section id="colors" className="bg-stone-900 rounded-xl p-6 border border-stone-800 md:col-span-2">
      <h2 className="text-2xl font-semibold mb-4">Colores</h2>
      <p className="text-stone-400 mb-6">Paleta de colores principal basada en naranjas vibrantes.</p>
      ...
      <div className="mt-8 p-4 bg-stone-800 rounded-lg">
        ...
        <ul className="text-sm text-stone-400 space-y-1">
          <li>
            <span className="text-orange-500">Orange 500</span> - Color primario para botones y enlaces
          </li>
          <li>
