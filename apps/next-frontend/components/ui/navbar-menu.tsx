  ...
  return (
    <div onMouseEnter={() => setActive(item)} className="relative">
      <motion.p
        ...
        className="cursor-pointer text-white hover:text-gray-300 px-4 py-2 text-sm font-medium"
      >
        {item}
      </motion.p>
      {active !== null && (
        ...
        >
          {active === item && children && (
            <>
              <div className="absolute top-[0px] left-[-20px] right-[-20px] bottom-[-20px] bg-transparent pointer-events-auto"></div>
