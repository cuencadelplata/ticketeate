...
export function EventCard({ title, description, price, date, image, category,category2 }: EventCardProps) {
  return (
    <div className="border-1.5 border-orange-600 rounded-xl shadow hover:shadow-lg transition overflow-hidden bg-orange-100">
      ...
      <div className="p-4">
        ...
        <p className="inline-block text-white text-xs bg-teal-500 rounded-xl w-16 h-4 mt-3 px-1">{category}</p>
        <p className="inline-block text-white text-xs bg-lime-500 rounded-xl w-16 h-4 mt-3 px-1">{category2}</p>
