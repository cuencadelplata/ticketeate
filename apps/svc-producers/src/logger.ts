/**
 * Sistema de logging estructurado para el servicio de productores
 */
...
/**
 * Instancia del logger para el servicio de productores
 */
export const logger = new ServiceLogger('svc-producers');
